...
namespace Editor
{
    public class StageMapImporter : AssetPostprocessor
    {
        ...
        {
            const string csvRelativePath = "Assets/Resources/StageMap/Map.csv";
            const string assetRelativePath = "Assets/Resources/StageMap/Map.asset";
            ...
            foreach (var path in importedAssets)
            {
                ...
                var db = AssetDatabase.LoadAssetAtPath<StagesMapSO>(assetRelativePath);
                if (db == null)
                {
                ...
                Debug.Log($"[StageDataImporter] {db.nodes.Count} entries imported into {assetRelativePath}");
            }
        }
